...
public:
    ...
    void paint(QPainter* painter, const QStyleOptionViewItem& option,
        ...
        painter->drawText(message_rect,
                          Qt::AlignLeft | Qt::AlignVCenter,
                          text_metrics.elidedText(last_message, Qt::ElideRight,
                                                  message_rect.width() - 42));
        ...
        if (unread_count > 0) {
            ...
            const auto badge_width = std::max(20, badge_metrics.horizontalAdvance(unread_text) + 10);
            const QRect badge_rect(row_rect.right() - badge_width - 10,
                                   row_rect.bottom() - 28,
                                   badge_width,
                                   20);
...
QVector<ConversationItem> defaultConversations() {
    return {
        {QStringLiteral("private:1002"),
         ...
         QStringLiteral("Bob"),
         QStringLiteral("See you at 18:30"),
        ...
        {QStringLiteral("group:2001"),
         ...
         QStringLiteral("Alice: Step49 UI model ready"),
...
QVector<ContactListItem> defaultContacts() {
    return {
        ...
        {QStringLiteral("Bob"), QStringLiteral("Offline"), QStringLiteral("B"), false, 0},
...
QVector<ContactListItem> defaultGroups() {
    return {
        {QStringLiteral("LiteIM Dev Group"),
         QStringLiteral("3 members"),
         QStringLiteral("G"),
         false,
         0},
        {QStringLiteral("Backend Notes"),
         QStringLiteral("2 members"),
         QStringLiteral("B"),
         false,
         0},
    };
