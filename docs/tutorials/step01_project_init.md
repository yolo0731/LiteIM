...
1. GoogleTest 是 C++ 后端常见工业标准，面试官也熟悉。
2. 自研小框架很难自然支持 fixture、参数化测试、death test 和 gMock。
3. GoogleTest 能和 CTest 原生集成。
...
| `docs/process/task_plan.md` | 更新 | 记录 Step 1 目标和完成状态 |
| `docs/process/findings.md` | 更新 | 记录工程初始化约束 |
| `docs/process/progress.md` | 更新 | 记录构建、server smoke 和 CTest 结果 |
| `docs/tutorials/step01_project_init.md` | 新增 | 讲解 CMake 工程初始化 |
...
自研框架虽然一开始简单，但后面很难支持 fixture、参数化测试、death test 和 gMock。这个项目目标是实习简历项目，用 GoogleTest 更贴近工程实践。
