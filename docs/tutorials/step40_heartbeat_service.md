...
| `docs/tutorials/step40_heartbeat_service.md` | 新增 | 讲解心跳业务层语义 |
| `docs/process/task_plan.md / docs/process/findings.md / docs/process/progress.md` | 更新 | 记录 Step 40 过程、边界和验证结果 |
