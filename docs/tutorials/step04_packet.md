...
| `docs/tutorials/step04_packet.md` | 新增 | 讲解 Packet wire shape |
| `docs/process/task_plan.md / docs/process/findings.md / docs/process/progress.md` | 更新 | 记录 Step 4 过程和验证结果 |
