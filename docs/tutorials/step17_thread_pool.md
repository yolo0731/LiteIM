...
| `docs/tutorials/step17_thread_pool.md` | 修改 | 承载本 Step 对应代码、测试或文档变化 |
...
这个问题的核心结论已经收敛到 `docs/process/findings.md`：worker 内部 stop 只发出停止请求，最终 join/cleanup 仍由 owner 线程完成。
