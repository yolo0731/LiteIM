...
public:
    ...
    Status findDeliveryStatus(std::uint64_t user_id, std::uint64_t message_id,
                              DeliveryStatus& status) override;
    ...
    Status ackPrivateMessageDelivery(std::uint64_t user_id, std::uint64_t message_id,
                                     MessageRecord& message) override;
