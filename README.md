...
- 新增 `isRequestType()`、`isResponseType()` 和 `isPushType()`，为后续 `MessageRouter`、Qt 客户端和 Python BotClient 区分请求、响应、推送打基础。
- `tests/protocol/` 新增 8 个 GoogleTest case；加上 Step 1 和 Step 2 测试，当前 CTest 共 23 个测试。
